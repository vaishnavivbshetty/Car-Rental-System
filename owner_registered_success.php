<html>
  ...
  <head>
    <title> Owner Signup | Royal Car Rental </title>
...
$query = "INSERT into owners(owner_name,owner_username,owner_email,owner_phone,owner_address,owner_password) VALUES('" . $owner_name . "','" . $owner_username . "','" . $owner_email . "','" . $owner_phone . "','" . $owner_address ."','" . $owner_password ."')";
...
<div class="container">
	<div class="jumbotron" style="text-align: center;">
		...
		<p>Login Now from <a href="ownerlogin.php">HERE</a></p>
	</div>
</div>
