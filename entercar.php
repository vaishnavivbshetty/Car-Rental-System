...
<body>
    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area" style="background-color:pink;">
        <form role="form" action="entercar1.php" enctype="multipart/form-data" method="POST" >
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;font-family:algerian"> Want to rent your car? Give us your car details. </h3>
    ...
    <div class="form-area" style="padding: 0px 100px 100px 100px;background-color:pink" >
        <form action="" method="POST">
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;font-family:algerian"> My Cars </h3>
<?php
// Storing Session
$user_check=$_SESSION['login_owner'];
$sql = "SELECT * FROM cars WHERE car_id IN (SELECT car_id FROM ownercars WHERE owner_username='$user_check');";
