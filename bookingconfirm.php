...
<?php
    ...
    $sql4 = "SELECT * FROM  cars c, owners cl, driver d, rentedcars rc WHERE c.car_id = '$car_id' AND d.driver_id = '$driver_id' AND cl.owner_username = d.owner_username";
...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
    ...
    <h2 class="text-center"> Thank you for visiting Royal Car Rental! We wish you have a safe ride. </h2>
