      ...
      <div class="form-area">
        ...
        <div ng-switch-default>
                ...
                <!-- </div>    -->
                    ...
                    <!-- <div class="form-group"> -->
                <h5>Fare: <?php echo("₹" . $ac_price . "/km  OR ₹" . $ac_price_per_day . "/day");?><h5>    
                <!-- </div>    -->
                     </div>
                     <div ng-switch-when="non_ac">
                     <!-- <div class="form-group"> -->
                <h5>Fare: <?php echo("₹" . $non_ac_price . "/km   OR  ₹" . $non_ac_price_per_day . "/day");?><h5>    
                <!-- </div>   -->
                     </div>
        </div>
         ...
         <h5> Choose charge type:  &nbsp;
            ...
            <br><br>
                ...
                <select name="driver_id_from_dropdown" ng-model="myVar1">
                        <?php
                        $sql2 = "SELECT * FROM driver d WHERE d.driver_availability = 'yes' AND d.owner_username IN (SELECT cc.owner_username FROM ownercars cc WHERE cc.car_id = '$car_id')";
                ...
                <?php
                        $sql3 = "SELECT * FROM driver d WHERE d.driver_availability = 'yes' AND d.owner_username IN (SELECT cc.owner_username FROM ownercars cc WHERE cc.car_id = '$car_id')";
