<html>
  ...
  <head>
    <title> customer Signup | Royal Car Rental </title>
  </head>
  <?php session_start(); ?>
...
$owner_username = $_SESSION['login_owner'];
$driver_availability = "yes";

$query = "INSERT into driver(driver_name,dl_number,driver_phone,driver_address,driver_gender,owner_username,driver_availability) VALUES('" . $driver_name . "','" . $dl_number . "','" . $driver_phone . "','" . $driver_address . "','" . $driver_gender ."','" . $owner_username ."','" . $driver_availability ."')";
