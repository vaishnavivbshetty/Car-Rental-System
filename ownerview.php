...
<?php $login_owner = $_SESSION['login_owner']; 

    $sql1 = "SELECT * FROM rentedcars rc, ownercars cc, customers c, cars WHERE cc.owner_username = '$login_owner' AND cc.car_id = rc.car_id AND rc.return_status = 'R' AND c.customer_username = rc.customer_username AND cc.car_id = cars.car_id";
...
?>
<div class="container">
      <div class="jumbotron" style="background-color:pink;font-family:algerian">
        <h1>Your Bookings</h1>
