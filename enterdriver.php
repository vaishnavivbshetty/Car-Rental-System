 ...
 <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area"  style="background-color:pink;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;font-family:algerian"> Enter Driver Details </h3>
    ...
    <div class="form-area" style="padding: 0px 100px 100px 100px;background-color:pink;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;font-family:algerian"> My Drivers </h3>
<?php
// Storing Session
$user_check=$_SESSION['login_owner'];
$sql = "SELECT * FROM driver d WHERE d.owner_username='$user_check' ORDER BY driver_name";
